...
df_original_total <- cbind(df_original_total, df_fact_nocip)
df_original_total$CLUSTER <- as.factor(clusters_final$cluster)

df_original_total %>% group_by(df_original_total$CLUSTER) %>% summarise(MediaPor)
clprofiles(clusters_final, df_original_total)
```
